...
const ClientDetail = () => {
  ...
  const renderContent = () => {
    switch (activeTab) {
      case 'overview':
        return <ClientOverview client={client} stats={stats} />;
      case 'prompts':
        return <ClientPrompts clientId={client.clientId} />;
      case 'users':
        return <ClientUsers clientId={client.clientId} />;
      case 'settings':
        return <ClientSettings client={client} onUpdate={fetchClientData} />;
      default:
        return <ClientOverview client={client} stats={stats} />;
    }
  };
...
const ClientOverview = ({ client, stats }: { client: Client; stats: ClientStats | null }) => {
  if (!stats) {
    return (
      <div className="text-center py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-200">
          ...
          <div className="space-y-4">
            {stats.topAiPlatforms.map((platform, index) => (
...
const ClientSettings = ({ client, onUpdate }: { client: Client; onUpdate: () => void }) => (
  <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-200">
